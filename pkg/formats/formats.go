...
const (
	...
	CY02JSON   = Format("cytrics+json;version=0.2")
	CDXFORMAT  = "cyclonedx"
	SPDXFORMAT = "spdx"
	CYFORMAT = "cytrics"
)
...
var (
	ListFormats = []Format{CDXFORMAT, SPDXFORMAT, CYFORMAT}
	List        = []Format{SPDX23TV, SPDX23JSON, SPDX22TV, SPDX22JSON, CDX14JSON, CDX15JSON, CY02JSON}
)
